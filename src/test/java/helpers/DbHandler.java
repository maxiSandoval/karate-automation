...
public class DbHandler {
    ...
    private static String connectionUrl = "jdbc:postgresql://localhost:5432/Pubs?user=postgres&password=admin";
    ...
    public static void addNewJobWithName(String jobName) {
        ...
        try (Connection connect = DriverManager.getConnection(connectionUrl, user, password)) {
            connect.createStatement().execute(
                    "INSERT INTO jobs (job_desc, min_lvl, max_lvl) VALUES ('" + jobName + "', 80, 120)");
